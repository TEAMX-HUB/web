...
*/
import{p as e}from"./mat4.js";import{c as t}from"./mat4f64.js";import{f as a}from"./vec3f64.js";import{rayLeighScaleHeight as r,atmosphereHeight as i}from"../views/3d/environment/atmosphereUtils.js";import{TextureCoordinateAttribute as o,TextureCoordinateAttributeType as n}from"../views/3d/webgl-engine/core/shaderLibrary/attributes/TextureCoordinateAttribute.glsl.js";import{ReadLinearDepth as s}from"../views/3d/webgl-engine/core/shaderLibrary/output/ReadLinearDepth.glsl.js";import{Gamma as l}from"../views/3d/webgl-engine/core/shaderLibrary/shading/Gamma.glsl.js";import{addMainLightDirection as c}from"../views/3d/webgl-engine/core/shaderLibrary/shading/MainLighting.glsl.js";import{Float2PassUniform as h}from"../views/3d/webgl-engine/core/shaderModules/Float2PassUniform.js";import{Float3PassUniform as d}from"../views/3d/webgl-engine/core/shaderModules/Float3PassUniform.js";import{Float4PassUniform as p}from"../views/3d/webgl-engine/core/shaderModules/Float4PassUniform.js";import{FloatPassUniform as m}from"../views/3d/webgl-engine/core/shaderModules/FloatPassUniform.js";import{glsl as u}from"../views/3d/webgl-engine/core/shaderModules/interfaces.js";import{Matrix4PassUniform as g}from"../views/3d/webgl-engine/core/shaderModules/Matrix4PassUniform.js";import{ShaderBuilder as f}from"../views/3d/webgl-engine/core/shaderModules/ShaderBuilder.js";import{Texture2DPassUniform as v}from"../views/3d/webgl-engine/core/shaderModules/Texture2DPassUniform.js";import{VertexAttribute as x}from"../views/3d/webgl-engine/lib/VertexAttribute.js";const y=a(parseFloat(Number(5802e-9).toFixed(6)),parseFloat(Number(13558e-9).toFixed(6)),parseFloat(Number(331e-7).toFixed(6))),D=3,b=a(D*parseFloat(Number(65e-8).toFixed(6)),D*parseFloat(Number(1881e-9).toFixed(6)),D*parseFloat(Number(85e-9).toFixed(6))),P=3996e-9,w=a(parseFloat(Number(y[0]+b[0]).toFixed(6)),parseFloat(Number(y[1]+b[1]).toFixed(6)),parseFloat(Number(y[2]+b[2]).toFixed(6)));function S(t){const a=new f;a.attributes.add(x.POSITION,"vec2"),a.include(o,{textureCoordinateType:n.Default}),a.varyings.add("worldRay","vec3"),a.varyings.add("eyeDir","vec3");const{vertex:D,fragment:b}=a;return D.uniforms.add(new g("inverseProjectionMatrix",((e,t)=>t.camera.inverseProjectionMatrix)),new g("inverseViewMatrix",((t,a)=>e(F,a.camera.viewMatrix)))),D.code.add(u`void main(void) {
vec3 posViewNear = (inverseProjectionMatrix * vec4(position, -1, 1)).xyz;
eyeDir = posViewNear;
worldRay = (inverseViewMatrix * vec4(posViewNear, 0)).xyz;
forwardTextureCoordinates();
gl_Position = vec4(position, 1, 1);
}`),b.uniforms.add(new d("backgroundColor",(e=>e.backgroundColor)),new h("radii",(e=>e.radii)),new d("cameraPosition",((e,t)=>t.camera.eye)),new p("heightParameters",(e=>e.heightParameters)),new m("innerFadeDistance",(e=>e.innerFadeDistance)),new m("altitudeFade",(e=>e.altitudeFade)),new v("depthTexture",(e=>e.depthTexture)),new m("hazeStrength",(e=>e.hazeStrength))),b.constants.add("betaRayleigh","vec3",y),b.constants.add("betaCombined","vec3",w),b.constants.add("betaMie","float",P),b.constants.add("scaleHeight","float",r*i),c(b),a.include(l),t.haze&&(b.include(s),b.uniforms.add(new h("nearFar",((e,t)=>t.camera.nearFar)))),b.code.add(u`vec2 sphereIntersect(vec3 start, vec3 dir, float radius, bool planet) {
float a = dot(dir, dir);
...
}`),b.code.add(u`float chapmanApproximation(float X, float h, float cosZenith) {
float c = sqrt(X + h);
float cExpH = c * exp(-h);
if (cosZenith >= 0.0) {
...
}`),b.code.add(u`float getOpticalDepth(vec3 position, vec3 dir, float h) {
