...
const utils = require('./utils-a9b215d0.js');
const dom = require('./dom-5b0be476.js');
const floatingUi = require('./floating-ui-4eab4126.js');
...
const locale = require('./locale-354affa5.js');
const openCloseComponent = require('./openCloseComponent-553f8395.js');
...
require('./debounce-13143535.js');
require('./observers-c2862e25.js');
...
const InputDatePicker = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onBlur: this.deactivate, onKeyDown: this.keyDownHandler }, this.localeData && (index.h("div", { class: "input-container" }, index.h("div", { class: "input-wrapper", onClick: this.onInputWrapperClick,
      ...
      ref: this.setStartWrapper }, index.h("calcite-input", { "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-expanded": dom.toAriaBoolean(this.open), "aria-haspopup": "dialog", class: `input ${this.layout === "vertical" && this.range ? `no-bottom-border` : ``}`, disabled: disabled, icon: "calendar", "number-button-type": "none", numberingSystem: numberingSystem, onCalciteInputInput: this.calciteInternalInputInputHandler, onCalciteInternalInputBlur: this.calciteInternalInputBlurHandler, onCalciteInternalInputFocus: this.startInputFocus, onFocus: this.startEndInputFocus, placeholder: this.localeData?.placeholder, readOnly: readOnly, role: "combobox", scale: this.scale, type: "text",
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.setStartInput }), this.renderToggleIcon(this.open && this.focusedInput === "start")), index.h("div", { "aria-hidden": dom.toAriaBoolean(!this.open), "aria-label": messages.chooseDate, "aria-live": "polite", "aria-modal": "true", class: {
        [CSS.menu]: true,
