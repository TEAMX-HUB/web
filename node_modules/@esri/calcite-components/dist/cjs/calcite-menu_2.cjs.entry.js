...
const resources = require('./resources-6fd6c9e3.js');
...
const CalciteMenuItem = class {
  ...
  renderItemContent(dir) {
    return (index.h(index.Fragment, null, this.iconStart && this.renderIconStart(), index.h("div", { class: CSS.textContainer }, index.h("span", null, this.text)), !this.href && this.hasSubmenu ? this.renderDropdownIcon(dir) : null, this.breadcrumb ? this.renderBreadcrumbIcon(dir) : null, this.iconEnd && this.renderIconEnd()));
  }
  render() {
