...
const resources$1 = require('./resources-1659631d.js');
const Heading = require('./Heading-1b3ab283.js');
const resources = require('./resources-74962238.js');
...
const Panel = class {
  ...
  renderHeaderNode() {
    ...
    const showHeader = hasHeaderContent ||
      ...
      closable ||
      hasMenuItems;
    return (index.h("header", { class: resources.CSS.header, hidden: !showHeader }, this.renderHeaderStartActions(), this.renderHeaderSlottedContent(), headerContentNode, this.renderHeaderActionsEnd()));
  }
  renderFooterNode() {
