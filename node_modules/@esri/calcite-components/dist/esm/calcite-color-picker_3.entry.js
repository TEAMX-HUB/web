 ...
 * v1.4.2
 */
import { r as registerInstance, c as createEvent, h, a as getElement, F as Fragment } from './index-a6760286.js';
import { i as isPrimaryPointerButton, b as getElementDir, f as focusElement, h as getModeName } from './dom-f74a09b7.js';
import { C as CSSColorMode, n as normalizeHex, a as hexify, o as opacityToAlpha, b as alphaToOpacity, c as alphaCompatible, p as parseMode, d as colorEqual, t as toNonAlphaMode, e as normalizeAlpha, f as toAlphaMode, g as normalizeColor, j as isLonghandHex, i as isValidHex, r as rgbToHex, k as hexChar } from './utils-ddd03fe1.js';
...
import { c as connectLocalized, d as disconnectLocalized } from './locale-b3c44dda.js';
import { c as clamp } from './math-e6aff5b3.js';
import { u as updateMessages, s as setUpMessages, c as connectMessages, d as disconnectMessages } from './t9n-a3e12422.js';
import { t as throttle } from './throttle-d688fe13.js';
import './guid-d5943b83.js';
import './resources-d08a6737.js';
import './observers-c20ec2dd.js';
import './debounce-b9072422.js';
...
const ColorPicker = class {
  constructor(hostRef) {
    ...
    this.renderChannel = (value, index, ariaLabel, direction, suffix) => {
      return (h("calcite-input", { class: CSS$2.channel, "data-channel-index": index, dir: direction, key: index, label: ariaLabel, lang: this.effectiveLocale, numberButtonType: "none", numberingSystem: this.numberingSystem, onCalciteInputChange: this.handleChannelChange, onCalciteInputInput: this.handleChannelInput, onKeyDown: this.handleKeyDown, scale: this.scale === "l" ? "m" : "s",
  ...
  render() {
    ...
    return (h("div", { class: CSS$2.container }, h("div", { class: CSS$2.controlAndScope }, h("canvas", { class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown,
      ...
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.initHueSlider }), h("div", { "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: { top: `${hueTop}px`, left: `${hueLeft}px` }, tabindex: "0",
      // eslint-disable-next-line react/jsx-sort-props
...
const ColorPickerHexInput = class {
  ...
  render() {
    ...
    return (h("div", { class: CSS$1.container }, h("calcite-input", { class: CSS$1.hexInput, label: messages?.hex || hexLabel, maxLength: 6, numberingSystem: this.numberingSystem, onCalciteInputChange: this.onHexInputChange, onCalciteInternalInputBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", scale: inputScale, value: hexInputValue,
      // eslint-disable-next-line react/jsx-sort-props
