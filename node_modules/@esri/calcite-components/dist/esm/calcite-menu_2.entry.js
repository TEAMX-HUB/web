 ...
 * v1.4.2
 */
import { r as registerInstance, h, H as Host, a as getElement, c as createEvent, F as Fragment } from './index-a6760286.js';
import { s as slotChangeGetAssignedElements, j as focusElementInGroup, f as focusElement, b as getElementDir } from './dom-f74a09b7.js';
...
const CalciteMenuItem = class {
  ...
  renderItemContent(dir) {
    return (h(Fragment, null, this.iconStart && this.renderIconStart(), h("div", { class: CSS.textContainer }, h("span", null, this.text)), !this.href && this.hasSubmenu ? this.renderDropdownIcon(dir) : null, this.breadcrumb ? this.renderBreadcrumbIcon(dir) : null, this.iconEnd && this.renderIconEnd()));
  }
  render() {
