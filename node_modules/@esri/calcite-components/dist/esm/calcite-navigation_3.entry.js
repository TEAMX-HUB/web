 ...
 * v1.4.2
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, a as getElement } from './index-a6760286.js';
import { d as slotChangeHasAssignedElement } from './dom-f74a09b7.js';
...
const CalciteNavigationLogo = class {
  ...
  render() {
    ...
    return (h(Host, null, h("a", { class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && h("img", { alt: this.label || "", class: CSS$1.image, src: thumbnail }), (heading || description) && (h("div", { class: CSS$1.container }, heading && (h("span", { "aria-label": this.heading, class: CSS$1.heading, key: CSS$1.heading }, heading)), description && (h("span", { "aria-label": this.description, class: CSS$1.description, key: CSS$1.description }, description)))))));
  }
