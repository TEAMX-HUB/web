...
<div className=" max-w-md  ">
    <h1>My Accounts</h1>
    <p className=" max-w-md  text-[11px]   ">make changes to your account</p>
</div>
...
<div className=" max-w-md  ">
    <h1>My Schedule</h1>
    <p className=" max-w-md  text-[11px]   ">Manage your saved account</p>
</div>
<div className="px-[50px] "><img src={chevron} alt="" /></div>
</div>
<div className="flex items-center p-5 space-x-4">
...
<div className=" max-w-md  ">
    ...
    <p className=" max-w-md  text-[11px]   ">College of Engineering, FECE.</p>
</div>
<div className="px-[50px] "><img src={chevron} alt="" /></div>
</div>
<div className="flex items-center p-5 space-x-4">
